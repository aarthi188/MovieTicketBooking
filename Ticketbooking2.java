...
public class Ticketbooking2 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.add(jLabel7);
        jLabel7.setBounds(80, 400, 140, 20);
        ...
        jPanel1.add(jLabel8);
        jLabel8.setBounds(80, 460, 120, 30);
        ...
        jButton1.setBounds(80, 580, 160, 50);
        ...
        jButton2.setBounds(320, 580, 190, 50);
        ...
        jButton3.setBounds(600, 580, 120, 40);

        jComboBox1.setFont(new java.awt.Font("Tahoma", 2, 18)); // NOI18N
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Master", "Bhoomi", "Kadan", "Jagamey Thanthiram" }));
        jPanel1.add(jComboBox1);
        jComboBox1.setBounds(260, 120, 250, 50);

        jComboBox2.setFont(new java.awt.Font("Tahoma", 2, 18)); // NOI18N
        jComboBox2.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "First Class", "Middle Class", "Last Class" }));
        jPanel1.add(jComboBox2);
        jComboBox2.setBounds(260, 380, 250, 50);

        jComboBox3.setFont(new java.awt.Font("Tahoma", 2, 18)); // NOI18N
        jComboBox3.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "9:00-11:30", "2:00-4:30", "6:00-8:30", "10:00-12:30" }));
        jPanel1.add(jComboBox3);
        jComboBox3.setBounds(260, 180, 250, 50);
        ...
        jComboBox4.setBounds(250, 470, 250, 50);
        jPanel1.add(jSpinner1);
        jSpinner1.setBounds(260, 260, 250, 40);
        jPanel1.add(jDateChooser1);
        jDateChooser1.setBounds(260, 320, 250, 40);

        jLabel1.setFont(new java.awt.Font("Tahoma", 2, 24)); // NOI18N
        jLabel1.setForeground(new java.awt.Color(204, 0, 204));
        jLabel1.setIcon(new javax.swing.ImageIcon("C:\\Users\\AARTHI\\Downloads\\p7.jpg")); // NOI18N
        jPanel1.add(jLabel1);
        jLabel1.setBounds(-230, -80, 990, 720);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
           try{
            ...
            String sql="insert into Ticketdetails2 values(?,?,?,?,?,?)";
            PreparedStatement pstat=conn.prepareStatement(sql);
            String mname;
            mname=jComboBox1.getSelectedItem().toString();
            pstat.setString(1, mname);
            String mtime;
            mtime=jComboBox3.getSelectedItem().toString();
            ...
            String mclass;
            mclass=jComboBox2.getSelectedItem().toString();
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try{
            ...
            String sql="delete from Ticketdetails2 where mseat=?";
            PreparedStatement pstat=conn.prepareStatement(sql);
